...
namespace Apache.Http.Client.Methods
{
	...
	/// </summary>
	/// <since>4.0</since>
	public interface IHttpUriRequest : IHttpRequest
	{
		/// <summary>
		...
		/// <summary>Aborts execution of the request.</summary>
		/// <remarks>Aborts execution of the request.</remarks>
		...
		/// <summary>Tests if the request execution has been aborted.</summary>
		/// <remarks>Tests if the request execution has been aborted.</remarks>
		/// <returns>
		/// <code>true</code> if the request execution has been aborted,
