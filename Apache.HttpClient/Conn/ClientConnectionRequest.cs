...
namespace Apache.Http.Conn
{
	...
	/// </summary>
	/// <since>4.0</since>
	[System.ObsoleteAttribute(@"(4.3) replaced by ConnectionRequest .")]
	public interface ClientConnectionRequest
	{
		...
		/// <see cref="ClientConnectionManager.Shutdown()">shut down</see>
		/// .
		/// Timeouts are handled with millisecond precision.
		/// If
		/// <see cref="AbortRequest()">AbortRequest()</see>
		...
		/// <summary>
		/// Aborts the call to
		/// <see cref="GetConnection(long, Sharpen.TimeUnit)">GetConnection(long, Sharpen.TimeUnit)
		/// 	</see>
		/// ,
