...
namespace Apache.Http.Conn.Scheme
{
	...
	/// </summary>
	/// <since>4.2</since>
	[System.ObsoleteAttribute(@"(4.3) use Apache.Http.Conn.Socket.LayeredConnectionSocketFactory"
		)]
	public interface SchemeLayeredSocketFactory : SchemeSocketFactory
	{
		/// <summary>
		...
		/// determined
		/// </exception>
		Socket CreateLayeredSocket(Socket socket, string target, int port, HttpParams @params
			);
	}
}
