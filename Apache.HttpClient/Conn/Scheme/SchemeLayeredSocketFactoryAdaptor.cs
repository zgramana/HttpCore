...
namespace Apache.Http.Conn.Scheme
{
	...
	internal class SchemeLayeredSocketFactoryAdaptor : SchemeSocketFactoryAdaptor, SchemeLayeredSocketFactory
	{
		private readonly LayeredSocketFactory factory;

		internal SchemeLayeredSocketFactoryAdaptor(LayeredSocketFactory factory) : base(factory
			)
		{
