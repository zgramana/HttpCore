...
namespace Apache.Http.Cookie
{
	...
	/// <since>4.1</since>
	[System.Serializable]
	public class CookieRestrictionViolationException : MalformedCookieException
	{
		private const long serialVersionUID = 7371235577078589013L;
		...
		/// message.
		/// </remarks>
		public CookieRestrictionViolationException() : base()
		{
		}
		...
		public CookieRestrictionViolationException(string message) : base(message)
		{
		}
	}
}
