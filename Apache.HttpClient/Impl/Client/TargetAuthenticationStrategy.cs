...
namespace Apache.Http.Impl.Client
{
	...
	/// </summary>
	/// <since>4.2</since>
	public class TargetAuthenticationStrategy : AuthenticationStrategyImpl
	{
		public static readonly Apache.Http.Impl.Client.TargetAuthenticationStrategy Instance
			 = new Apache.Http.Impl.Client.TargetAuthenticationStrategy();

		public TargetAuthenticationStrategy() : base(HttpStatus.ScUnauthorized, AUTH.WwwAuth
			)
		{
		}
