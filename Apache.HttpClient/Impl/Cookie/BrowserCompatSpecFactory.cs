...
namespace Apache.Http.Impl.Cookie
{
	...
	/// <see cref="BrowserCompatSpec">BrowserCompatSpec</see>
	/// instances.
	/// </summary>
	/// <since>4.0</since>
	public class BrowserCompatSpecFactory : CookieSpecFactory, CookieSpecProvider
	{
		public enum SecurityLevel
		{
			SecuritylevelDefault,
			SecuritylevelIeMedium
		}

		private readonly string[] datepatterns;

		private readonly BrowserCompatSpecFactory.SecurityLevel securityLevel;
		...
		public BrowserCompatSpecFactory(string[] datepatterns) : this(null, BrowserCompatSpecFactory.SecurityLevel
			.SecuritylevelDefault)
		{
		}

		public BrowserCompatSpecFactory() : this(null, BrowserCompatSpecFactory.SecurityLevel
			.SecuritylevelDefault)
		{
		}
