...
namespace Apache.Http.Impl.Cookie
{
	...
	/// <see cref="RFC2965Spec">RFC2965Spec</see>
	/// instances.
	/// </summary>
	/// <since>4.0</since>
	public class RFC2965SpecFactory : CookieSpecFactory, CookieSpecProvider
	{
		private readonly string[] datepatterns;

		private readonly bool oneHeader;

		public RFC2965SpecFactory(string[] datepatterns, bool oneHeader) : base()
		{
			this.datepatterns = datepatterns;
			this.oneHeader = oneHeader;
		}

		public RFC2965SpecFactory() : this(null, false)
		{
		}
