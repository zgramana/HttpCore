...
{
	/// <summary><tt>"CommentURL"</tt> cookie attribute handler for RFC 2965 cookie spec.
	/// 	</summary>
	/// <remarks><tt>"CommentURL"</tt> cookie attribute handler for RFC 2965 cookie spec.
	/// 	</remarks>
	/// <since>4.0</since>
	public class RFC2965CommentUrlAttributeHandler : CookieAttributeHandler
	{
		public RFC2965CommentUrlAttributeHandler() : base()
		{
		}
