...
{
	/// <since>4.0</since>
	public class BasicMaxAgeHandler : AbstractCookieAttributeHandler
	{
		public BasicMaxAgeHandler() : base()
		{
		}
		...
		public override void Parse(SetCookie cookie, string value)
		{
			...
			cookie.SetExpiryDate(Sharpen.Extensions.CreateDate(Runtime.CurrentTimeMillis() + 
				age * 1000L));
		}
	}
}
