...
namespace Apache.Http.Impl.Auth
{
	...
	/// <see cref="BasicScheme">BasicScheme</see>
	/// instances.
	/// </summary>
	/// <since>4.0</since>
	public class BasicSchemeFactory : AuthSchemeFactory, AuthSchemeProvider
	{
		private readonly Encoding charset;

		/// <since>4.3</since>
		public BasicSchemeFactory(Encoding charset) : base()
		{
			this.charset = charset;
		}

		public BasicSchemeFactory() : this(null)
		{
		}
