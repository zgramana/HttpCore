...
namespace Apache.Http.Impl.Auth
{
	...
	/// <see cref="KerberosScheme">KerberosScheme</see>
	/// instances.
	/// </summary>
	/// <since>4.2</since>
	public class KerberosSchemeFactory : AuthSchemeFactory, AuthSchemeProvider
	{
		private readonly bool stripPort;

		public KerberosSchemeFactory(bool stripPort) : base()
		{
			this.stripPort = stripPort;
		}

		public KerberosSchemeFactory() : this(false)
		{
		}
