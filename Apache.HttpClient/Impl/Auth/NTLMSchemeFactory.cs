...
namespace Apache.Http.Impl.Auth
{
	...
	/// <see cref="NTLMScheme">NTLMScheme</see>
	/// instances configured to use the default
	/// <see cref="NTLMEngine">NTLMEngine</see>
	/// implementation.
	/// </summary>
	/// <since>4.1</since>
	public class NTLMSchemeFactory : AuthSchemeFactory, AuthSchemeProvider
	{
