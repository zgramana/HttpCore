...
namespace Apache.Http.Impl.Auth
{
	...
	/// <see cref="DigestScheme">DigestScheme</see>
	/// instances.
	/// </summary>
	/// <since>4.0</since>
	public class DigestSchemeFactory : AuthSchemeFactory, AuthSchemeProvider
	{
		private readonly Encoding charset;

		/// <since>4.3</since>
		public DigestSchemeFactory(Encoding charset) : base()
		{
			this.charset = charset;
		}

		public DigestSchemeFactory() : this(null)
		{
		}
